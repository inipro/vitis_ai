...
echo "#####################################"
# method 1
freeze_graph --input_meta_graph=./method1/tf_chkpt.ckpt.meta \
...
# method 2
freeze_graph --input_meta_graph=./method2/tf_chkpt.ckpt.meta \
...
# method 3
freeze_graph --input_meta_graph=./method3/tf_chkpt.ckpt.meta \
