...
if UPSCALE=="True" :
        fname = "../keras_model/fcn8ups/ep" + str(EPOCHS) + "_trained_fcn8ups_" + str(WIDTH) + "x" + str(HEIGHT) + ".hdf5"
else :
        fname = "../keras_model/fcn8/ep" + str(EPOCHS) + "_trained_fcn8_" + str(WIDTH) + "x" + str(HEIGHT) + ".hdf5"
...
hist1 = model.fit(X_train,Y_train, validation_data=(X_valid,Y_valid), batch_size=BATCH_SIZE,epochs=EPOCHS,callbacks=callbacks_list,verbose=2)
