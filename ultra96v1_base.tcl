...
################################################################
# This is a generated script based on design: ultra96v1_base
#
...
# source ultra96v1_base_script.tcl
...
if { $list_projs eq "" } {
   file delete -force ultra96v1_base
   create_project ultra96v1_base ultra96v1_base -part xczu3eg-sbva484-1-e
...
set design_name ultra96v1_base
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net ps_e_axi_periph_M00_AXI [get_bd_intf_pins axi_intc_0/s_axi] [get_bd_intf_pins interconnect_axilite/M00_AXI]

  # Create port connections
  connect_bd_net -net ARESETN_1 [get_bd_pins interconnect_axilite/ARESETN] [get_bd_pins interconnect_axilite/M00_ARESETN] [get_bd_pins interconnect_axilite/S00_ARESETN] [get_bd_pins proc_sys_reset_2/interconnect_aresetn]
  ...
  connect_bd_net -net emio_uart0_ctsn_0_1 [get_bd_ports BT_ctsn] [get_bd_pins ps_e/emio_uart0_ctsn]
  connect_bd_net -net interrupt_concat_dout [get_bd_pins axi_intc_0/intr] [get_bd_pins interrupt_concat/dout]
  connect_bd_net -net proc_sys_reset_2_peripheral_aresetn [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins proc_sys_reset_2/peripheral_aresetn]
  connect_bd_net -net ps_e_emio_uart0_rtsn [get_bd_ports BT_rtsn] [get_bd_pins ps_e/emio_uart0_rtsn]
  connect_bd_net -net ps_e_pl_clk0 [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins ps_e/pl_clk0]
  connect_bd_net -net ps_e_pl_resetn0 [get_bd_pins clk_wiz_0/resetn] [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins proc_sys_reset_1/ext_reset_in] [get_bd_pins proc_sys_reset_2/ext_reset_in] [get_bd_pins proc_sys_reset_3/ext_reset_in] [get_bd_pins proc_sys_reset_4/ext_reset_in] [get_bd_pins proc_sys_reset_5/ext_reset_in] [get_bd_pins proc_sys_reset_6/ext_reset_in] [get_bd_pins ps_e/pl_resetn0]

  # Create address segments
  assign_bd_address -offset 0x80000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs axi_intc_0/S_AXI/Reg] -force
...
generate_target  all  [get_files  ./ultra96v1_base/ultra96v1_base.srcs/sources_1/bd/ultra96v1_base/ultra96v1_base.bd]
set_property generate_synth_checkpoint true [get_files -norecurse *.bd]
make_wrapper -files [get_files ./ultra96v1_base/ultra96v1_base.srcs/sources_1/bd/ultra96v1_base/ultra96v1_base.bd] -top
add_files -norecurse ./ultra96v1_base/ultra96v1_base.srcs/sources_1/bd/ultra96v1_base/hdl/ultra96v1_base_wrapper.v
import_files -fileset constrs_1 -norecurse ultra96v1_base.xdc
