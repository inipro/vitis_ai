...
if { $list_projs eq "" } {
   file delete -force ultra96v2_base
   create_project ultra96v2_base ultra96v2_base -part xczu3eg-sbva484-1-e
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins axi_intc_0/s_axi] [get_bd_intf_pins interconnect_axilite/M00_AXI]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_LPD [get_bd_intf_pins interconnect_axilite/S00_AXI] [get_bd_intf_pins ps_e/M_AXI_HPM0_LPD]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_emio_uart0_rtsn [get_bd_ports BT_rtsn] [get_bd_pins ps_e/emio_uart0_rtsn]
  ...
  assign_bd_address -offset 0x80000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces ps_e/Data] [get_bd_addr_segs axi_intc_0/S_AXI/Reg] -force
...
generate_target  all  [get_files  ./ultra96v2_base/ultra96v2_base.srcs/sources_1/bd/ultra96v2_base/ultra96v2_base.bd]
set_property generate_synth_checkpoint true [get_files -norecurse *.bd]
make_wrapper -files [get_files ./ultra96v2_base/ultra96v2_base.srcs/sources_1/bd/ultra96v2_base/ultra96v2_base.bd] -top
add_files -norecurse ./ultra96v2_base/ultra96v2_base.srcs/sources_1/bd/ultra96v2_base/hdl/ultra96v2_base_wrapper.v
import_files -fileset constrs_1 -norecurse ultra96v2_base.xdc
