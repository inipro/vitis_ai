platform -name ultra96v2_base -desc "A reVISION platform targeting the ultra94v2 evaluation board, which includes 2GB of DDR4 for the Processing System, optimized to work with reVISION development environment. More information at http://zedboard.org/product/ultra96-v2-development-board" -hw ./ultra96v2_base.xsa -out ./output
