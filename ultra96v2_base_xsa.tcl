...
set_property PFM_NAME {em.avnet.com:ultra96v2:ultra96v2_base:1.0} [get_files [current_bd_design].bd]
...
write_hw_platform -force -include_bit ./ultra96v2_base.xsa

validate_hw_platform ./ultra96v2_base.xsa
